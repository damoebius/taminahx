...
org_tamina_html_component_HTMLApplication.prototype = {
	loadComponents: function() {
		...
		while(tag.hasNext()) {
			...
			window.document.customElements.define(tag1,componentClass);
		}
	}
...
Main.prototype = $extend(org_tamina_html_component_HTMLApplication.prototype,{
	build: function() {
		...
		assetLoader.load(new org_tamina_net_AssetURL("toto.js")).then(function(value2) {
			...
			console.log("./Main.hx:94:",value3.message);
		});
		...
		assetListLoader.load([new org_tamina_net_AssetURL("https://code.jquery.com/jquery-3.2.1.slim.min.js"),new org_tamina_net_AssetURL("https://code.createjs.com/easeljs-0.8.2.min.js")]).then(function(value4) {
			console.log("./Main.hx:97:",value4);
		})["catch"](function(value5) {
			console.log("./Main.hx:97:",value5);
		});
		...
		request.send().then(function(response) {
			console.log("./Main.hx:108:",response.ResponseHeader);
		})["catch"](function(error1) {
			console.log("./Main.hx:110:",error1.message);
		});
	}
	,myComponent_creationCompleteHandler: function(evt) {
		console.log("./Main.hx:115:","hophophop");
	}
	,__class__: Main
});
		...
		while(c != org_tamina_html_component_HTMLComponent && c != null) {
			...
			while(_g < _g1) {
				...
				if(Object.prototype.hasOwnProperty.call(field,"skinpart")) {
					...
					if(element == null) {
						console.log("./org/tamina/html/component/HTMLComponent.hx:246:","skinpart is null: " + metaFields[i] + " from " + this.nodeName);
					}
...
test_html_view_TestComponent.prototype = $extend(org_tamina_html_component_HTMLComponent.prototype,{
	...
	,toto: function() {
		console.log("./test/html/view/TestComponent.hx:38:","clicked " + this._rand);
		this._index++;
...
test_html_view_TestComponent.__meta__ = { obj : { view : ["test/html/view/TestComponent.html"]}, fields : { _otherComponent : { skinpart : [""]}, _messageSpan : { skinpart : [""]}}};
